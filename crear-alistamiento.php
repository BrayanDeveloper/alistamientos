        ...
        <div class="container">
            ...
            <div class="col-sm-8">
                <center>
                    ...
                    <legend><h2>Nuevo Alistamiento</h2></legend>
                <form action="funciones/funciones.php" method="post">
                    <input type="hidden" name="crear-alistamiento" value="crear-alistamiento">
                    ...
                    <br>
                    PLACA: <input type="text" name="placa" class="campos form-control" required="required"> #N INTERNO <input type="text" name="n_interno" class="campos form-control" required="required"><br>
                    CANTIDAD PUESTOS: <input type="number" name="cantidad_puestos" class="campos form-control" required="required">
                    <br>
                    CLASE VEHICULO: <input type="text" name="clase_vehiculo" class="campos form-control" required="required">
                    <br>
                    VALOR: <input type="number" name="valor" class="campos form-control" required="required">
                    <br>
                    RUTA OPERATIVA: <input type="text" name="ruta_operativa" class="campos form-control" required="required">
                    <br>
                    KILOMETRAJE: <input type="text" name="kilometraje" class="campos form-control" required="required">
                    <br>
                    EMPRESA VEHICULO: <input type="TEXT" name="empresa_vehiculo" class="campos form-control" required="required">
                    <br>
                    CEDULA PROPIETARIO: <input type="number" name="cedula_propietario" class="campos form-control" required="required">
                    <br>
                    NOMBRE PROPIETARIO: <input type="text" name="nombre_propietario" class="campos form-control" required="required">
                    <br>
                    CEDULA CONDUCTOR: <input type="number" name="cedula_conductor" class="campos form-control" required="required">
                    <br>
                    NOMBRE CONDUCTOR: <input type="text" name="nombre_conductor" class="campos form-control" required="required">
                    <br>
                    ESTADO FINAL: <select name="estado_final" class="campos form-control"><option value="aprobada" required="required">Aprobada</option><option value="desaprobada">Desaprobada</option></select required="required">
                    <br>
                    OBSERVACION GENERAL: <textarea name="observacion_general" width="200px" height="100px" class="campos form-control"></textarea>
                    <br>
                    FIRMA: <img src="img/firma/<?php echo $_SESSION['firma']; ?>" width="100">
                    <br>
                    <input type="submit" class="btn-primary" style="padding: 10px; float: left;" value="Guardar Alistamiento">
