...
if ($_SESSION['username']) {
    ...
    $usuarios = $conexion->conectar()->query($sql)->fetchAll();
?>
<!doctype html>
...
<head>
    ...
    <title>Usuario Cootransunidos</title>
        ...
        <div class="container">
            ...
            <div class="col-sm-8">
                <center>
                    ...
                    <legend><h2>Editar mi usuario</h2></legend>
                    <?php foreach ($usuarios as $alis) {
                     ?>
                <form action="funciones/funciones.php" method="post">
                    <input type="hidden" name="editar-usuario" value="editar-usuario">
                    

                    
                    Nombre: <input type="text" name="nombre" class="campos form-control" value="<?php echo $alis['nombre']; ?>"> Apellido: <input type="text" name="apellido" class="campos form-control" value="<?php echo $alis['apellido']; ?>"><br>
                    N# Username <input type="text" name="username" class="campos form-control" value="<?php echo $alis['username']; ?>" disabled> Correo Electronico - <input type="text" name="email" class="form-control" value="<?php echo $alis['email']; ?>"><br>
                    Clave de acceso: 
                    
                    <br>
                    
                   <input type="text" name="clave" class="campos form-control" value="<?php echo $alis['password']; ?>">
                    <br>
                    <input type="submit" class="btn-primary" style="padding: 10px; float: left;" value="Actualizar Datos">
