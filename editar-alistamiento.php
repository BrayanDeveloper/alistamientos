...
<head>
    ...
    <title>Alistamiento Cootransunidos</title>
        ...
        <div class="container">
            ...
            <div class="col-sm-8">
                <center>
                    ...
                    <legend><h2>Editar Alistamiento</h2></legend>
                    <?php foreach ($alistamientos as $alis) {
                     ?>
                <form action="funciones/funciones.php" method="post">
                    <input type="hidden" name="editar-alistamiento" value="editar-alistamiento">
                    <input type="hidden" name="id" value="<?php echo $alis['id_alistamiento']; ?>">

                    <legend>COOTRASNUNIDOS</legend>
                    <P>NIT: 890501119-7</P>
                    <P>RESOLUCION:</P>
                    FECHA INSPECCION: <input type="text" name="fecha_inspeccion" class="campos" value="<?php echo $alis['fecha_inspeccion']; ?>"> HORA: <input type="text" name="hora_inspeccion" class="campos" value="<?php echo $alis['hora_inspeccion']; ?>"><br>
                    N# ALISTAMIENTO <input type="number" name="n_alistamiento" class="campos form-control" value="<?php echo $alis['n_alistamiento']; ?>" disabled> (DIST) - <input type="text" name="distribuccion" class="form-control" value="<?php echo $alis['distribuccion']; ?>"><br>
                    TIPO ALISTAMIENTO: 
                    <select name="tipo_alistamiento" class="form-control">
                        <option value="<?php echo $alis['tipo_alistamiento']; ?>"><?php echo $alis['tipo_alistamiento']; ?></option>
                        <option value="Preoperacional">Preoperacional</option>
                    </select>
                    <br>
                    USUARIO: <?php echo $alis['usuario_alistamiento']; ?>
                    <br>
                    <h4>DETALLE DEL ALISTAMIENTO</h4>
                    <br>
                    PLACA: <input type="text" name="placa" class="campos form-control" value="<?php echo $alis['placa']; ?>"> #N INTERNO <input type="text" name="n_interno" class="campos form-control" value="<?php echo $alis['n_interno']; ?>"><br>
                    CANTIDAD PUESTOS: <input type="number" name="cantidad_puestos" class="campos form-control" value="<?php echo $alis['cantidad_puestos']; ?>">
                    <br>
                    CLASE VEHICULO: <input type="text" name="clase_vehiculo" class="campos form-control" value="<?php echo $alis['clase_vehiculo']; ?>">
                    <br>
                    VALOR: <input type="number" name="valor" class="campos form-control" value="<?php echo $alis['valor']; ?>">
                    <br>
                    RUTA OPERATIVA: <input type="text" name="ruta_operativa" class="campos form-control" value="<?php echo $alis['ruta_operativa']; ?>">
                    <br>
                    KILOMETRAJE: <input type="text" name="kilometraje" class="campos form-control" value="<?php echo $alis['kilometraje']; ?>">
                    <br>
                    EMPRESA VEHICULO: <input type="TEXT" name="empresa_vehiculo" class="campos form-control" value="<?php echo $alis['empresa_vehiculo']; ?>">
                    <br>
                    CEDULA PROPIETARIO: <input type="number" name="cedula_propietario" class="campos form-control" value="<?php echo $alis['cedula_propietario']; ?>">
                    <br>
                    NOMBRE PROPIETARIO: <input type="text" name="nombre_propietario" class="campos form-control" value="<?php echo $alis['nombre_propietario']; ?>">
                    <br>
                    CEDULA CONDUCTOR: <input type="number" name="cedula_conductor" class="campos form-control" value="<?php echo $alis['cedula_conductor']; ?>">
                    <br>
                    NOMBRE CONDUCTOR: <input type="text" name="nombre_conductor" class="campos form-control" value="<?php echo $alis['nombre_conductor']; ?>">
                    <br>
                    ESTADO FINAL: <select name="estado_final" class="campos form-control" value="<?php echo $alis['n_interno']; ?>"><option value="<?php echo $alis['estado_final']; ?>"><?php echo $alis['estado_final']; ?></option><option value="aprobada">Aprobada</option><option value="desaprobada">Desaprobada</option></select>
                    <br>
                    OBSERVACION GENERAL: <textarea name="observacion_general" width="200px" height="100px" class="campos form-control"><?php echo $alis['observacion_general']; ?></textarea>
                    <br>
                    FIRMA: <img src="img/firma/<?php echo $_SESSION['firma']; ?>">
                    <br>
                    <input type="submit" class="btn-primary" style="padding: 10px; float: left;" value="Actualizar Alistamiento">
