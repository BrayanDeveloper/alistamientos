...
if ($_SESSION['username']) {
    ...
    $sql_alistamiento_por_mi = "SELECT count(id_alistamiento)as conteo_alistamiento_por_mi FROM alistamientos where id_usuario=$_SESSION[id_usuario]";
    $conteo_alistamiento = $conexion->conectar()->query($sql_alistamiento_por_mi)->fetchAll();
    if ($conteo_alistamiento) {
        foreach ($conteo_alistamiento as $key) {
           $conteo_total_alistamiento_por_mi = $key['conteo_alistamiento_por_mi'];
        }
    }
?>
<!doctype html>
...
<head>
    ...
    <title>Alineamientos Reportes</title>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30">
                        <div class="website-traffic-ctn">
                            <h2><span class="counter"><?php echo $conteo_total_alistamiento; ?></span></h2>
                            <p>Alistamientos Totales <br><a href="reporte-excel-global">Descargar Reporte Excel</a></p>
                        </div>
                        <!-- <div class="sparkline-bar-stats1">1,2,3,4,5,6,<?php echo $conteo_total_alistamiento; ?></div> -->
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30">
                        <div class="website-traffic-ctn">
                            <h2><span class="counter"><?php echo $conteo_total_alistamiento_por_mi; ?></span></h2>
                            <p>Alistamientos Totales Por mi <br><a href="reporte-excel-user">Descargar Reporte Excel</a></p>
                        </div>
                        <!-- <div class="sparkline-bar-stats2">1,2,3,4,5,6,<?php echo $conteo_total_alistamiento_por_mi; ?></div> -->
                    </div>
                </div>
                <!-- <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
