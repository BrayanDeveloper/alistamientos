...
if ($_SESSION['username']) {
    ...
    $sql = "SELECT * FROM alistamientos where id_usuario=$_SESSION[id_usuario] order by id_alistamiento desc";
    ...
    <div class="notika-status-area">
        <div class="container">
            ...
            <div class="col-sm-12">
                    ...
                    <legend><h2>Alistamientos</h2></legend>
            ...
            ?>
            <tr class="tabla">
                <td><?php echo $alis['fecha_inspeccion']; ?></td>
                <td><?php echo $alis['placa']; ?></td>
                <td><?php echo $alis['estado_final']; ?></td>
                <td><a href="editar-alistamiento?id=<?php echo $alis['id_alistamiento']; ?>" class="btn text-warning"><i class="fa fa-edit" title="Editar Alistamiento"></i></a></td>
                <td><a href="funciones/funciones?id_delete_alistamiento=<?php echo $alis['id_alistamiento']; ?>" class="btn text-danger" title="Eliminar Alistamiento"><i class="fa fa-remove"></i></a></td>
            ...
            ?>
            <tr>
                <td>No tiene alistamientos Registrados</td> 
                <td><a href="crear-alistamiento" class="btn btn-primary"><i class="fa fa-align-left"></i> Nuevo Alistamiento</a></td>
            </tr>
            <?php 
            }
            ?>
