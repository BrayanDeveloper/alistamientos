...
<body>
    ...
    <div class="notika-status-area">
        <div class="container">
            ...
            ?>
            <tr>
                <td>Aun no hay Respuestas por el Tiket</td> 
                <td><a href="crear-respuesta-tiket?id=<?php echo $_GET['id']; ?>" class="btn btn-primary"><i class="fa fa-align-left"></i> Nuevo Respuesta al Tiket: <?php echo @$_GET['tiket']; ?> </a></td>
            </tr>
            <?php 
            }
            ?>
