...
if ($_SESSION['username']) {
    ...
    $sql = "SELECT * FROM logs where id_usuario=$_SESSION[id_usuario] order by id_log desc";
    ...
    <div class="notika-status-area">
        <div class="container">
            ...
            <div class="col-sm-12">
                    ...
                    <legend><h2>Mis Ingresos al Sistema</h2></legend>
                    <br>
            ...
            <?php 
            if ($logs) {
                foreach ($logs as $alis) {
            ?>
            <tr class="tabla">
                <td><?php echo $alis['fecha']; ?></td>
                <td><?php echo $alis['accion']; ?></td>
