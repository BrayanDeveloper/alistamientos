        ...
        <div class="container">
            ...
            <div class="col-sm-8">
                <center>
                    ...
                    <legend><h2>Subir mi Firma</h2></legend>
                    <p style="color: dodgerblue;">La Firma debe de ser en formato <strong style="color:red;">.jpg</strong></p>
                <form action="funciones/funciones.php" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="subir-firma" value="subir-firma">
                    <input type="file" name="file" class="btn-primary">
                    <br><br>
                    <input type="submit" name="" value="Guardar Firma" class="btn-success" style="padding: 5px;">
                </form>
